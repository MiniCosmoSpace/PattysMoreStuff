...
public class BlockWoolFence extends FourWayBlock
{
    private final VoxelShape[] renderShapes;
    
    public BlockWoolFence(final String name, final Block.Properties properties) {
        super(2.0f, 2.0f, 16.0f, 16.0f, 24.0f, properties);
        this.setRegistryName("pattysmorestuff", name);
        this.setDefaultState((BlockState)((BlockState)((BlockState)((BlockState)((BlockState)((BlockState)this.stateContainer.getBaseState()).with((IProperty)BlockWoolFence.NORTH, (Comparable)false)).with((IProperty)BlockWoolFence.EAST, (Comparable)false)).with((IProperty)BlockWoolFence.SOUTH, (Comparable)false)).with((IProperty)BlockWoolFence.WEST, (Comparable)false)).with((IProperty)BlockWoolFence.WATERLOGGED, (Comparable)false));
    ...
    public BlockState getStateForPlacement(final BlockItemUseContext context) {
        ...
        return (BlockState)((BlockState)((BlockState)((BlockState)((BlockState)super.getStateForPlacement(context).with((IProperty)BlockWoolFence.NORTH, (Comparable)this.func_220111_a(blockstate, blockstate.func_224755_d(iblockreader, blockpos2, Direction.SOUTH), Direction.SOUTH))).with((IProperty)BlockWoolFence.EAST, (Comparable)this.func_220111_a(blockstate2, blockstate2.func_224755_d(iblockreader, blockpos3, Direction.WEST), Direction.WEST))).with((IProperty)BlockWoolFence.SOUTH, (Comparable)this.func_220111_a(blockstate3, blockstate3.func_224755_d(iblockreader, blockpos4, Direction.NORTH), Direction.NORTH))).with((IProperty)BlockWoolFence.WEST, (Comparable)this.func_220111_a(blockstate4, blockstate4.func_224755_d(iblockreader, blockpos5, Direction.EAST), Direction.EAST))).with((IProperty)BlockWoolFence.WATERLOGGED, (Comparable)(ifluidstate.getFluid() == Fluids.WATER));
    }
