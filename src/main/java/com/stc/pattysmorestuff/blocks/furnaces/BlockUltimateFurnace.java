...
public class BlockUltimateFurnace extends AbstractUltimateFurnaceBlock
{
    public BlockUltimateFurnace(final String name, final Block.Properties properties) {
        super(properties);
    ...
    public TileEntity createNewTileEntity(final IBlockReader worldIn) {
        return (TileEntity)new UltimateFurnaceTileEntity();
    }
