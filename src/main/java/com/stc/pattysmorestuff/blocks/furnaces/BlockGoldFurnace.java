...
public class BlockGoldFurnace extends AbstractGoldFurnaceBlock
{
    public BlockGoldFurnace(final String name, final Block.Properties properties) {
        super(properties);
    ...
    public TileEntity createNewTileEntity(final IBlockReader worldIn) {
        return (TileEntity)new GoldFurnaceTileEntity();
    }
