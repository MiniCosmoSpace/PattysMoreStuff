...
public class BlockIronFurnace extends AbstractIronFurnaceBlock
{
    public BlockIronFurnace(final String name, final Block.Properties properties) {
        super(properties);
    ...
    public TileEntity createNewTileEntity(final IBlockReader worldIn) {
        return (TileEntity)new IronFurnaceTileEntity();
    }
