...
public abstract class AbstractGoldFurnaceBlock extends AbstractFurnaceBlock
{
    public static final DirectionProperty FACING;
    public static final BooleanProperty LIT;
    
    protected AbstractGoldFurnaceBlock(final Block.Properties p_i50000_1_) {
        super(p_i50000_1_);
        this.setDefaultState((BlockState)((BlockState)((BlockState)this.stateContainer.getBaseState()).with((IProperty)AbstractGoldFurnaceBlock.FACING, (Comparable)Direction.NORTH)).with((IProperty)AbstractGoldFurnaceBlock.LIT, (Comparable)false));
    }
    ...
    public void animateTick(final BlockState stateIn, final World worldIn, final BlockPos pos, final Random rand) {
        if (stateIn.get(AbstractGoldFurnaceBlock.LIT)) {
            ...
            final Direction direction = (Direction)stateIn.get((IProperty)AbstractGoldFurnaceBlock.FACING);
