...
public class BlockObsidianFurnace extends AbstractObsidianFurnaceBlock
{
    public BlockObsidianFurnace(final String name, final Block.Properties properties) {
        super(properties);
    ...
    public TileEntity createNewTileEntity(final IBlockReader worldIn) {
        return (TileEntity)new ObsidianFurnaceTileEntity();
    }
