...
public class BlockSlimeStairs extends StairsBlock
{
    public BlockSlimeStairs(final String name, final BlockState defaultState, final Block.Properties properties) {
        super(defaultState, properties.slipperiness(0.8f));
