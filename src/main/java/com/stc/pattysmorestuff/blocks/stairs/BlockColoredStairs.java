...
public class BlockColoredStairs extends StairsBlock
{
    public BlockColoredStairs(final String name, final BlockState defaultState, final Block.Properties properties) {
        super(defaultState, properties.hardnessAndResistance(3.0f, 3.0f));
