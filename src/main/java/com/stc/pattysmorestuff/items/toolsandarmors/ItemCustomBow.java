...
public class ItemCustomBow extends BowItem {
    ...
    public ItemCustomBow(String name, Item.Properties properties) {
        super(properties);
        ...
        if (entityLiving instanceof PlayerEntity) {
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    worldIn.playSound((PlayerEntity)null, playerentity.chasingPosX, playerentity.chasingPosY, playerentity.chasingPosZ, SoundEvents.ENTITY_ARROW_SHOOT, SoundCategory.PLAYERS, 1.0F, 1.0F / (random.nextFloat() * 0.4F + 1.2F) + f * 0.5F);
