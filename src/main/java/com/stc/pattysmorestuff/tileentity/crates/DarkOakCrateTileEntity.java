...
public class DarkOakCrateTileEntity extends LockableLootTileEntity implements INamedContainerProvider
{
    ...
    public DarkOakCrateTileEntity() {
        super((TileEntityType)ModTileEntities.DARK_OAK_STORAGE_CRATE_TE);
    ...
    protected ITextComponent getDefaultName() {
        return (ITextComponent)new TranslationTextComponent("Dark Oak Crate", new Object[0]);
    }
    ...
    public static int getPlayersUsing(final IBlockReader reader, final BlockPos posIn) {
        ...
        if (blockstate.hasTileEntity()) {
            ...
            if (tileentity instanceof DarkOakCrateTileEntity) {
                return ((DarkOakCrateTileEntity)tileentity).numPlayersUsing;
            }
        }
        return 0;
    }
