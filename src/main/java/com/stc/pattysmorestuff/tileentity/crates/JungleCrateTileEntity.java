...
public class JungleCrateTileEntity extends LockableLootTileEntity implements INamedContainerProvider
{
    ...
    public JungleCrateTileEntity() {
        super((TileEntityType)ModTileEntities.JUNGLE_STORAGE_CRATE_TE);
    ...
    protected ITextComponent getDefaultName() {
        return (ITextComponent)new TranslationTextComponent("Jungle Crate", new Object[0]);
    }
    ...
    public static int getPlayersUsing(final IBlockReader reader, final BlockPos posIn) {
        ...
        if (blockstate.hasTileEntity()) {
            ...
            if (tileentity instanceof JungleCrateTileEntity) {
                return ((JungleCrateTileEntity)tileentity).numPlayersUsing;
            }
        }
        return 0;
    }
