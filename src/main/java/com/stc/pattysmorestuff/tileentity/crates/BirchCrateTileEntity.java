...
public class BirchCrateTileEntity extends LockableLootTileEntity implements INamedContainerProvider
{
    ...
    public BirchCrateTileEntity() {
        super((TileEntityType)ModTileEntities.BIRCH_STORAGE_CRATE_TE);
    ...
    protected ITextComponent getDefaultName() {
        return (ITextComponent)new TranslationTextComponent("Birch Crate", new Object[0]);
    }
    ...
    public static int getPlayersUsing(final IBlockReader reader, final BlockPos posIn) {
        ...
        if (blockstate.hasTileEntity()) {
            ...
            if (tileentity instanceof BirchCrateTileEntity) {
                return ((BirchCrateTileEntity)tileentity).numPlayersUsing;
            }
        }
        return 0;
    }
