...
public class SpruceCrateTileEntity extends LockableLootTileEntity implements INamedContainerProvider
{
    ...
    public SpruceCrateTileEntity() {
        super((TileEntityType)ModTileEntities.SPRUCE_STORAGE_CRATE_TE);
    ...
    protected ITextComponent getDefaultName() {
        return (ITextComponent)new TranslationTextComponent("Spruce Crate", new Object[0]);
    }
    ...
    public static int getPlayersUsing(final IBlockReader reader, final BlockPos posIn) {
        ...
        if (blockstate.hasTileEntity()) {
            ...
            if (tileentity instanceof SpruceCrateTileEntity) {
                return ((SpruceCrateTileEntity)tileentity).numPlayersUsing;
            }
        }
        return 0;
    }
