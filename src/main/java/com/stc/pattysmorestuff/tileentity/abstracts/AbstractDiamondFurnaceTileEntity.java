...
public abstract class AbstractDiamondFurnaceTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
    ...
    public AbstractDiamondFurnaceTileEntity(TileEntityType<?> tileTypeIn, IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn, int cookSpeed, int extraOutput) {
        super(tileTypeIn);
    ...
    public void tick() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                this.world.setBlockState(this.pos, this.world.getBlockState(this.pos).with(AbstractDiamondFurnaceBlock.LIT, Boolean.valueOf(this.isBurning())), 3);
            }
        }
    ...
    private static void func_214003_a(PlayerEntity p_214003_0_, int p_214003_1_, float p_214003_2_) {
        ...
        while(p_214003_1_ > 0) {
            ...
            p_214003_1_ -= j;
            p_214003_0_.world.addEntity(new ExperienceOrbEntity(p_214003_0_.world, p_214003_0_.chasingPosX, p_214003_0_.chasingPosY + 0.5D, p_214003_0_.chasingPosZ + 0.5D, j));
        }
