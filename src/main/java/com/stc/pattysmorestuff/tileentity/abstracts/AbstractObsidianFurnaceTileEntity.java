...
public abstract class AbstractObsidianFurnaceTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity
{
    ...
    public AbstractObsidianFurnaceTileEntity(final TileEntityType<?> tileTypeIn, final IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn, final int cookSpeed, final int extraOutput) {
        ...
        this.furnaceData = (IIntArray)new IIntArray() {
            public int get(final int index) {
                switch (index) {
                    case 0: {
                        return AbstractObsidianFurnaceTileEntity.this.burnTime;
                    }
                    case 1: {
                        return AbstractObsidianFurnaceTileEntity.this.recipesUsed;
                    }
                    case 2: {
                        return AbstractObsidianFurnaceTileEntity.this.cookTime;
                    }
                    case 3: {
                        return AbstractObsidianFurnaceTileEntity.this.cookTimeTotal;
                    }
                    default: {
                        return 0;
                    }
            ...
            public void set(final int index, final int value) {
                switch (index) {
                    case 0: {
                        AbstractObsidianFurnaceTileEntity.this.burnTime = value;
                        break;
                    }
                    case 1: {
                        AbstractObsidianFurnaceTileEntity.this.recipesUsed = value;
                        break;
                    }
                    case 2: {
                        AbstractObsidianFurnaceTileEntity.this.cookTime = value;
                        break;
                    }
                    case 3: {
                        AbstractObsidianFurnaceTileEntity.this.cookTimeTotal = value;
                        break;
                    }
                }
            }
    ...
    public void tick() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag2 = true;
                this.world.setBlockState(this.pos, (BlockState)this.world.getBlockState(this.pos).with((IProperty)AbstractObsidianFurnaceBlock.LIT, (Comparable)this.isBurning()), 3);
            }
        }
        if (flag2) {
            this.markDirty();
    ...
    public int[] getSlotsForFace(final Direction side) {
        if (side == Direction.DOWN) {
            return AbstractObsidianFurnaceTileEntity.SLOTS_DOWN;
        }
        return (side == Direction.UP) ? AbstractObsidianFurnaceTileEntity.SLOTS_UP : AbstractObsidianFurnaceTileEntity.SLOTS_HORIZONTAL;
    }
