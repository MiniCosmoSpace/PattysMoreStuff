...
public abstract class AbstractUltimateFurnaceTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity
{
    ...
    public AbstractUltimateFurnaceTileEntity(final TileEntityType<?> tileTypeIn, final IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn, final int cookSpeed, final int extraOutput) {
        ...
        this.furnaceData = (IIntArray)new IIntArray() {
            public int get(final int index) {
                switch (index) {
                    case 0: {
                        return AbstractUltimateFurnaceTileEntity.this.burnTime;
                    }
                    case 1: {
                        return AbstractUltimateFurnaceTileEntity.this.recipesUsed;
                    }
                    case 2: {
                        return AbstractUltimateFurnaceTileEntity.this.cookTime;
                    }
                    case 3: {
                        return AbstractUltimateFurnaceTileEntity.this.cookTimeTotal;
                    }
                    default: {
                        return 0;
                    }
            ...
            public void set(final int index, final int value) {
                switch (index) {
                    case 0: {
                        AbstractUltimateFurnaceTileEntity.this.burnTime = value;
                        break;
                    }
                    case 1: {
                        AbstractUltimateFurnaceTileEntity.this.recipesUsed = value;
                        break;
                    }
                    case 2: {
                        AbstractUltimateFurnaceTileEntity.this.cookTime = value;
                        break;
                    }
                    case 3: {
                        AbstractUltimateFurnaceTileEntity.this.cookTimeTotal = value;
                        break;
                    }
                }
            }
    ...
    public void tick() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag2 = true;
                this.world.setBlockState(this.pos, (BlockState)this.world.getBlockState(this.pos).with((IProperty)AbstractUltimateFurnaceBlock.LIT, (Comparable)this.isBurning()), 3);
            }
        }
        if (flag2) {
            this.markDirty();
    ...
    public int[] getSlotsForFace(final Direction side) {
        if (side == Direction.DOWN) {
            return AbstractUltimateFurnaceTileEntity.SLOTS_DOWN;
        }
        return (side == Direction.UP) ? AbstractUltimateFurnaceTileEntity.SLOTS_UP : AbstractUltimateFurnaceTileEntity.SLOTS_HORIZONTAL;
    }
