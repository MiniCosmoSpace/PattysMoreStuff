...
public abstract class AbstractEmeraldFurnaceTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity
{
    ...
    public AbstractEmeraldFurnaceTileEntity(final TileEntityType<?> tileTypeIn, final IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn, final int cookSpeed, final int extraOutput) {
        ...
        this.furnaceData = (IIntArray)new IIntArray() {
            public int get(final int index) {
                switch (index) {
                    case 0: {
                        return AbstractEmeraldFurnaceTileEntity.this.burnTime;
                    }
                    case 1: {
                        return AbstractEmeraldFurnaceTileEntity.this.recipesUsed;
                    }
                    case 2: {
                        return AbstractEmeraldFurnaceTileEntity.this.cookTime;
                    }
                    case 3: {
                        return AbstractEmeraldFurnaceTileEntity.this.cookTimeTotal;
                    }
                    default: {
                        return 0;
                    }
            ...
            public void set(final int index, final int value) {
                switch (index) {
                    case 0: {
                        AbstractEmeraldFurnaceTileEntity.this.burnTime = value;
                        break;
                    }
                    case 1: {
                        AbstractEmeraldFurnaceTileEntity.this.recipesUsed = value;
                        break;
                    }
                    case 2: {
                        AbstractEmeraldFurnaceTileEntity.this.cookTime = value;
                        break;
                    }
                    case 3: {
                        AbstractEmeraldFurnaceTileEntity.this.cookTimeTotal = value;
                        break;
                    }
                }
            }
    ...
    public void tick() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag2 = true;
                this.world.setBlockState(this.pos, (BlockState)this.world.getBlockState(this.pos).with((IProperty)AbstractEmeraldFurnaceBlock.LIT, (Comparable)this.isBurning()), 3);
            }
        }
        if (flag2) {
            this.markDirty();
    ...
    public int[] getSlotsForFace(final Direction side) {
        if (side == Direction.DOWN) {
            return AbstractEmeraldFurnaceTileEntity.SLOTS_DOWN;
        }
        return (side == Direction.UP) ? AbstractEmeraldFurnaceTileEntity.SLOTS_UP : AbstractEmeraldFurnaceTileEntity.SLOTS_HORIZONTAL;
    }
