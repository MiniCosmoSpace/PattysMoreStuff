...
public abstract class AbstractIronFurnaceTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity
{
    ...
    public AbstractIronFurnaceTileEntity(final TileEntityType<?> tileTypeIn, final IRecipeType<? extends AbstractCookingRecipe> recipeTypeIn, final int cookSpeed, final int extraOutput) {
        ...
        this.furnaceData = (IIntArray)new IIntArray() {
            public int get(final int index) {
                switch (index) {
                    case 0: {
                        return AbstractIronFurnaceTileEntity.this.burnTime;
                    }
                    case 1: {
                        return AbstractIronFurnaceTileEntity.this.recipesUsed;
                    }
                    case 2: {
                        return AbstractIronFurnaceTileEntity.this.cookTime;
                    }
                    case 3: {
                        return AbstractIronFurnaceTileEntity.this.cookTimeTotal;
                    }
                    default: {
                        return 0;
                    }
            ...
            public void set(final int index, final int value) {
                switch (index) {
                    case 0: {
                        AbstractIronFurnaceTileEntity.this.burnTime = value;
                        break;
                    }
                    case 1: {
                        AbstractIronFurnaceTileEntity.this.recipesUsed = value;
                        break;
                    }
                    case 2: {
                        AbstractIronFurnaceTileEntity.this.cookTime = value;
                        break;
                    }
                    case 3: {
                        AbstractIronFurnaceTileEntity.this.cookTimeTotal = value;
                        break;
                    }
                }
            }
    ...
    public void tick() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag2 = true;
                this.world.setBlockState(this.pos, (BlockState)this.world.getBlockState(this.pos).with((IProperty)AbstractIronFurnaceBlock.LIT, (Comparable)this.isBurning()), 3);
            }
        }
        if (flag2) {
            this.markDirty();
    ...
    public int[] getSlotsForFace(final Direction side) {
        if (side == Direction.DOWN) {
            return AbstractIronFurnaceTileEntity.SLOTS_DOWN;
        }
        return (side == Direction.UP) ? AbstractIronFurnaceTileEntity.SLOTS_UP : AbstractIronFurnaceTileEntity.SLOTS_HORIZONTAL;
    }
